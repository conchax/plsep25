...
<div class="container">
    ...
    <div class="row align-items-center justify-content-center">
        <?php 
        // Usamos el bucle nativo de WordPress para mantener la consulta de búsqueda activa
        if ( have_posts() ) : 
            while ( have_posts() ) : the_post(); ?>
                <div class="col-lg-8 my-3">
                    <article class="post">
                        <?php
                        // get_permalink() genera el enlace correcto hacia la entrada
                        printf( 
                            '<h3 class="%s"><a class="link-green" href="%s">%s</a></h3>', 
                            'entry-title color: var(--color-text)!important;', 
        ...
        <?php else : ?>
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-5 ">
                    <div id="contenido">
                        <form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get" class="form-only-controls mt-4">
                            <div class="input-group">
                                ...
                                <input type="text" name="s" placeholder="Busca en PL-SEP" value="<?php echo get_search_query(); ?>" class="form-control text-left autocomplete" />
