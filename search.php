          ...
          if ($searchresult->have_posts() ) : ?>
                ...
                while ($searchresult->have_posts() ) : $searchresult->the_post(); ?>
                    <div class="col-lg-8 my-3">
                        <article class="post">
                            <?php
                            printf( '<h3 class="%s"><a class="link-green" href="%s">%s</a></h3>', 'entry-title color: var(--color-text)!important;', esc_url( $post_link ), wp_kses_post( get_the_title() ) );
                            echo excerpt('50'); 
                            ?>
                        </article>
                        <hr class="my-3">
