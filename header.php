    ...
    <div class="aside-section aside-left">
      <div class="aside-content">
        <a href="https://registro.prepaenlinea.sep.gob.mx/">
          <img class="bannerFull" alt="Banner" fetchpriority="high" src="https://prepaenlinea.sep.gob.mx/assets/banner-registro.webp"  alt="registro">
          <img class="bannerFullR" alt="Banner" fetchpriority="high" src="https://prepaenlinea.sep.gob.mx/assets/banner-registro-m.webp"  alt="registro">
        </a>
      </div>
    </div>
