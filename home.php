  ...
  <section class="header-blog">
      <div class="container">
          <div class="row align-items-center" style="min-height: 300px;">
              <div class="col"><h4 class="elementor-heading-title text-lg-start text-center ">Boletines PL-SEP</h4></div>
          </div>
      </div>
  </section>
  <section>
    ...
    <section>
      ...
      <div class="container-xxl">
        <div class="row mt-5">
          ...
          ( 'post_type' => 'post', 'post_status' => 'publish', 'has_password' => false, 'posts_per_page' => 6 ,  'paged' => get_query_var('paged') ? get_query_var('paged') : 1, 'post__not_in' => array ((35061)))); 
          ?>
