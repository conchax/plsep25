...
function funcion_footer()
{
  ...
  wp_enqueue_script("particles", "https://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js");  
  wp_enqueue_script("plsep-js-particles", get_template_directory_uri() . "/js/script.js");
